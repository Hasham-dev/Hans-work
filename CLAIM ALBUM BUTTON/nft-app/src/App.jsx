...
const App = () => {
  ...
  const connectWallet = async () => {
    if (typeof window.ethereum !== "undefined") {
      ...
      alert("Please install MetaMask or enable it in your browser to connect.");
    }
  };
  ...
  return (
    <div>
      {account ? (
        <div>
          <span>{formatAddress(account)}</span> - <span>{balance} BNB</span>
          <button onClick={checkTokenOwnership}>Check My Tokens</button>
        </div>
      ) : (
